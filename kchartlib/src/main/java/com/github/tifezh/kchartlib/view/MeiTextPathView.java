...
public class MeiTextPathView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //处理包裹内容的情况
        int warpDefaultSize = DensityUtil.dip2px(100);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (mStopLength > mPathMeasure.getLength()) {
            mStopLength = mStopLength - mPathMeasure.getLength();
            mPathMeasure.getSegment(0, mPathMeasure.getLength(), mDstPath, true);
            if (!mPathMeasure.nextContour()) {
                break;
            }
        }
        mPathMeasure.getSegment(0, mStopLength, mDstPath, true);
