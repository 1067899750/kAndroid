package com.github.tifezh.kchartlib.chart.direct;
...
public class MeiHeartView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int warpDefaultSize = DisplayUtil.dip2px(getContext(), 100);
        if (widthMode == MeasureSpec.AT_MOST && heightMode == MeasureSpec.AT_MOST) {
            widthSize = heightSize = widthMeasureSpec;
    ...
    private void canvasHeart(Canvas canvas) {
        for (int i = 0; i < mHeartArray.size(); i++) {
            ...
            //位移到x,y
            mMatrix.setTranslate(heart.x, heart.y);
     ...
     * @param bitmap
     */
    private void setHeartBitmap(int type, Bitmap bitmap) {
